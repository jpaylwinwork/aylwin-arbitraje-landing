export default function Hero() {
  return (
    <section
      id="inicio"
      className="bg-gradient-to-b from-navy-900 via-navy-800 to-navy-700 text-white"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-24 sm:py-32">
        <p className="text-gold-500 text-sm font-bold uppercase tracking-[0.25em] mb-6">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <a
            href="#contacto"
            className="inline-flex items-center justify-center rounded-md bg-gold-600 px-8 py-4 text-base font-bold text-white hover:bg-gold-500 transition-colors"
          >
            Evaluar mi caso
          </a>
          <a
