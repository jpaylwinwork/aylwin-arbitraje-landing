      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-20 sm:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl font-semibold leading-tight text-balance">
            La experiencia de Aylwin Abogados en resolución de controversias
          </h2>
          <p className="mt-6 text-white/80 leading-relaxed">
            ...
            del país en resolución de controversias.
          </p>
          <p className="mt-4 text-white/80 leading-relaxed">
            El estudio ha sido reconocido por Best Lawyers, por Legal500 y por
            Leaders League en resolución de disputas.
          </p>
        </div>
        <div className="rounded-lg border border-white/15 bg-white/5 p-8">
          ...
          <ul className="mt-6 space-y-4 text-sm text-white/80">
            {[
              "Dedicación a arbitraje comercial y derecho administrativo",
              ...
              "Evaluación honesta de la viabilidad de cada caso, antes de litigar",
            ].map((item) => (
